...
class ui:
    ...
    def __init__(self):
        ...
        self.target1 = Gobject(130,420)  
        self.target2 = Gobject(130,420)
        self.current_target2_anime = 0
        self.ball1 = Ball(130,450,self.img_ball,self.img_path)
    ...
    def set_text_display(self,window):
        [x,y],time,[velx,vely],s_travel = self.ball1.val_all()
        pos = self.text_font.render("(x,y): "+ "(" +str(x) + "," +str(y)+")",True,(0,0,0))
        time = self.text_font.render("time: "+ str(time) + ' s',True,(0,0,0))
        velx = self.text_font.render("volx: "+ str(velx) ,True,(0,0,0))
        vely = self.text_font.render("voly: "+str(vely),True,(0,0,0))
        ...
        l = [k,k2,display,pos,time,velx,vely,s_travel]
